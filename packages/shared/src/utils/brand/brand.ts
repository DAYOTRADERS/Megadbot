...
const isDomainAllowed = (domain_name: string) => {
    ...
    return /^(((.*)\.)?(localhost:8443|pages.dev|binary\.(sx|com)|deriv\.(com|me|be|dev)|dollarprinters-site\.vercel\.app|dollarprinters\.site|bmbtraderstool\.vercel\.app|merricktradinghub\.site))$/.test(domain_name);
};
