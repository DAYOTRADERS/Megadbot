...
const isDomainAllowed = (domain_name: string) => {
    ...
    return /^(((.*)\.)?(localhost:8443|pages.dev|binary\.(sx|com)|deriv\.(com|me|be|dev)|MegadBot\.vercel\.app|MegadBot\.com|bmbtraderstool\.vercel\.app|merricktradinghub\.site))$/.test(domain_name);
};
