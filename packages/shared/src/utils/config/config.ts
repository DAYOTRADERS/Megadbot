...
export const domain_app_ids = {
    'smarttraderstool.com': 105723,
    'deriv.app': 105723,
    'app.deriv.com': 105723,
    'staging-app.deriv.com': 105723,
    'app.deriv.me': 105723,
    'staging-app.deriv.me': 105723,
    'app.deriv.be': 105723,
    'staging-app.deriv.be': 105723,
    'binary.com': 105723,
    'test-app.deriv.com': 105723,
    'royal-app-seven.vercel.app': 105723,
    'star-eight-ruby.vercel.app': 105723,
    'beleiver.vercel.app': 105723,
    'goon-puce.vercel.app': 105723,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 105723 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 105723;
